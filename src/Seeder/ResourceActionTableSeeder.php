...
class ResourceActionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceAction::query()
            ...
            ->create([	'id' => '518', 	'resource' => '304', 	'name' => 'VisitorWishlistListAction', 	'description' => 'Action to list all wishlists of a visitor', 	'title' => 'Wishlists', 											])
            ->create([	'id' => '519', 	'resource' => '304', 	'name' => 'VisitorSharedWishlistListAction', 	'description' => 'Action to list all wishlist shared with this visitor', 	'title' => 'Wishlists', 											])
            ...
            ->create([	'id' => '521', 	'resource' => '305', 	'name' => 'WishlistProductsListAction', 	'description' => 'List Item details of a wishlist', 	'title' => 'Products', 											])
            ->create([	'id' => '522', 	'resource' => '304', 	'name' => 'VisitorDetailsAction', 	'description' => 'Action to view details of a visitor', 	'title' => 'Details', 											])
            ->create([	'id' => '523', 	'resource' => '305', 	'name' => 'WishlistMessagesListAction', 	'description' => 'Action to list all messages in a wishlist', 	'title' => 'Messages', 											])
            ->create([	'id' => '524', 	'resource' => '305', 	'name' => 'ManageWishlistProductsAction', 	'description' => 'Action to manage products in a wishlist', 	'title' => 'Products', 											])
